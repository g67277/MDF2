...
- (void) refreshTwitter {
    ...
    if (accountStore != nil) {
        ...
        if (accountType != nil){
            ...
            UIAlertView *notice = [[UIAlertView alloc] initWithTitle:@"Notice" message:@"Please swipe down to populate" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
            [notice show];
